...
This project was developed as part of a college assignment/project to understand:
...
4. Open `index.html` using any modern web browser such as:
...
3. When the "=" button is pressed:
   ...
   * The expression is split into operands.
   * The operation is performed using a JavaScript switch-case statement.
4. The result is displayed on the calculator screen.
...
* Basic Project Deployment using GitHub
